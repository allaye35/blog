 ...
 */
final class Version20240622203821 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE article (id INT AUTO_INCREMENT NOT NULL, mots_cles_id INT DEFAULT NULL, commantaires_id INT DEFAULT NULL, email VARCHAR(255) NOT NULL, titre VARCHAR(255) NOT NULL, contenu LONGTEXT NOT NULL, INDEX IDX_23A0E66C0BE80DB (mots_cles_id), INDEX IDX_23A0E66A71DC132 (commantaires_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE utilisateur (id INT AUTO_INCREMENT NOT NULL, commentaires_id INT DEFAULT NULL, articles_id INT DEFAULT NULL, email VARCHAR(255) NOT NULL, INDEX IDX_1D1C63B317C4B2B0 (commentaires_id), INDEX IDX_1D1C63B31EBAF6CC (articles_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
